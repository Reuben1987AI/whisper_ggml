...
#if TRUE || defined(GGML_USE_OPENBLAS)
...
static void ggml_compute_forward_out_prod_f32(
    ...
    // TODO: #if TRUE || defined(GGML_USE_OPENBLAS) || defined(GGML_USE_CLBLAST)
...
#if TRUE || defined(GGML_USE_OPENBLAS) || defined(GGML_USE_CUBLAS) || defined(GGML_USE_CLBLAST)
    return 1;
#else
    return 0;
#endif
